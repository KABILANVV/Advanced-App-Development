...
if(apply){
  ...
  return(
    <div>
    <div className='main' >{text}{text.length<=37?"":<div style={{paddingLeft:"700px"}}><Button onClick={()=>SetApply(true)} style={{fontFamily:'fuggles',fontSize:"30px",backgroundColor:"rgb(255, 255, 255)" ,color:"black", }} variant="contained" color="primary">Apply Now<ArrowForwardIcon/></Button></div>}</div>
    </div>
  );
}
